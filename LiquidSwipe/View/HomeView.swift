   ...
   var body: some View {
      ZStack {
         ...
         ForEach(oo.data.indices.reversed(), id: \.self) { index in
            ...
            //MARK: - Left
               .clipShape(LiquidBlob(offset: offset, location: location))
               .overlay(
...
//                                 if offset.width > getRect().width / 5 * 4 {
//                                    offset.width = getRect().height * 2
//                                 } else {
                                    offset = .zero
//                                 }
                              }
...
//                                    fakeIndex += 1
//
//                                    //Обновление оригинального индекса
...
//            first.offset.width = getRect().height * 2
